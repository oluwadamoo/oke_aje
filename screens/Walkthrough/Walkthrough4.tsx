...
const Walkthrough4 = ({ animate }: any) => {
...
if(animate){
    ...
    return (
        ...
        >
            <Image source={images.walkthrough_02_01} style={{ ...styles.image, top: "35%", left: '35%', width: 106, height: 161, zIndex: 1 }} />
            <Image source={images.walkthrough_02_02} style={{ ...styles.image, top: "50%", left: '50%', }} />
